...
# 숫자 크기를 48포인트로 엄청 크게 키워서 멀리서도 잘 보이게 했습니다.
...
exit_button.pack(pady=40, ipady=12, ipadx=40) # 버튼 가로/세로 내부 여백 대폭 확대
